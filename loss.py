...
def custom_loss(y_true, y_pred):
    ...
    complete_loss_value = huber_loss_value + 2000*pt_quantile_loss_25 + 2000*pt_quantile_loss_75 # + 0.5*K.mean((phi_pred_25 - phi_truth)**2) + 0.5*K.mean((phi_pred_75 - phi_truth)**2)# + phi_quantile_loss_25 + phi_quantile_loss_75
